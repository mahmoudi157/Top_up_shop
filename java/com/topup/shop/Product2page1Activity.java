...
public class Product2page1Activity extends AppCompatActivity {
	...
	private DatabaseReference product2page1 = _firebase.getReference("product2page1");
	private ChildEventListener _product2page1_child_listener;
	private Intent i = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.product2page1);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_product2page1_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				product2page1.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
		...
		product2page1.addChildEventListener(_product2page1_child_listener);
	}
	...
	public class Gridview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			amount.setTextSize((int)8);
			linear2.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					if (Category.getText().toString().contains("social")) {
					...
					if (Category.getText().toString().contains("out")) {
						...
						AestheticDialog.showFlashDialog(Product2page1Activity.this, "STOCK OUT", "This products is currently out of stock", AestheticDialog.ERROR);
					}
					_clickAnimation(linear2);
				}
			});
