...
public class Product1Page4Activity extends AppCompatActivity {
	...
	private DatabaseReference product1page4 = _firebase.getReference("product1page4");
	private ChildEventListener _product1page4_child_listener;
	private TimerTask t;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.product1_page4);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_product1page4_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				product1page4.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
		...
		product1page4.addChildEventListener(_product1page4_child_listener);
	...
	public class Gridview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			linear2.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					if (Category.getText().toString().contains("out")) {
						_clickAnimation(linear2);
						AestheticDialog.showFlashDialog(Product1Page4Activity.this, "STOCK OUT", "This products is currently out of stock", AestheticDialog.ERROR);
					}
				}
			});
			...
			if (Category.getText().toString().contains("out")) {
				Price.setTextColor(0xFFF44336);
				Category2.setTextColor(0xFFF44336);
			}
