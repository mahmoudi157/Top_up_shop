...
public class Product1Page2Activity extends AppCompatActivity {
	...
	private DatabaseReference product1page2 = _firebase.getReference("product1page2");
	private ChildEventListener _product1page2_child_listener;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.product1_page2);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_product1page2_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				product1page2.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
		...
		product1page2.addChildEventListener(_product1page2_child_listener);
			...
			linear2.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View _view) {
					...
					if (Category.getText().toString().contains("out")) {
						_clickAnimation(linear2);
						AestheticDialog.showFlashDialog(Product1Page2Activity.this, "STOCK OUT", "This products is currently out of stock", AestheticDialog.ERROR);
					}
				}
			});
